...
function compararCartas(cartaUno, cartaDos){
    if(cartaUno.alt !== cartaDos.alt){
        ...
        setTimeout(mostrarMensajePorPantalla, (DOS_SEGUNDOS/2), "Intenta de Nuevo!!!");
        setTimeout(habilitarCarta, DOS_SEGUNDOS, cartaUno);
        setTimeout(habilitarCarta, DOS_SEGUNDOS, cartaDos);
    }else{
        cantidadDeCartasPares++;
        setTimeout(mostrarMensajePorPantalla, (DOS_SEGUNDOS/2),"Muy Bien, as acertado!!!");
    };
    if(6 === cantidadDeCartasPares){
        setTimeout(mostrarMensajePorPantalla, (DOS_SEGUNDOS*2),"Felicitaciones, ganaste el juego!!!");
